- opencode agent + bigpickle model (free), this i find pretty decent.
- opencode + gemini is awesome. I used Gemini 3.5 Flash Lite Google.

- pi agent + openrouter/free , this is okay. I did see some hallucinations. 
- need to explore more on pi agent and its powerful features.
